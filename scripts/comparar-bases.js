...
const TABLAS = [
  ...
  'cobros_vacantes', 'discount_codes', 'email_cola', 'email_log',
  'espacio_reservas', 'espacios', 'event_form_fields',
  ...
  'profiles', 'promociones', 'puesto_transferencias', 'puntos_balance', 'push_subscriptions',
  'recintos', 'recompensas',
  'sesion_inscripciones', 'speakers', 'sponsors',
  'sugerencias_catalogo', 'sugerencias_dinamica', 'talento_resenas', 'tarea_log', 'tareas',
  'ticket_interacciones', 'ticket_movimientos', 'ticket_puestos', 'ticket_type_espacios',
  'ticket_types', 'tickets',
  'torneo_calificaciones', 'torneo_categorias', 'torneo_criterios', 'torneo_equipos',
  'torneo_jurados', 'torneo_partidos', 'torneo_ronda_participantes', 'torneo_rondas', 'torneos',
