...
const LLAVES_ESTRECHAS = {
  ...
  /* Las zonas y el plano donde se colocan. Van juntas porque la pantalla de
     Zonas enseña el mapa y la del Mapa coloca zonas: una sin la otra deja el
     trabajo a medias. */
  gestionar_zonas: ['zonas', 'mapa'],
  ...
  gestionar_acreditacion: ['wallet', 'puntos', 'credenciales',
    /* Qué datos de contacto enseña el carné al escanearlo. Es parte del
       carné, así que lo decide quien lo diseña. */
    'tarjeta_contacto'],
};
