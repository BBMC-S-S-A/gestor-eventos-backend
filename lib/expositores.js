...
const CAMPOS_EDITABLES_ORGANIZADOR = ['nombre', 'descripcion', 'logo_url', 'stand',
  ...
  /* El NIT de la empresa (0129). Está en las DOS listas de escritura: lo
     normal es que lo escriba la propia empresa en su ficha, pero quien organiza
     una rueda suele dar de alta a las empresas él mismo desde una lista que le
     pasó la cámara de comercio, y ahí el NIT viene en la lista. */
  'nit',
...
const CAMPOS_EDITABLES_EXPOSITOR = ['nombre', 'descripcion', 'logo_url', 'stand',
  ...
  'sitio_web', 'redes', 'categoria_negocio', 'galeria', 'nit',
